...
const base =
  "press inline-flex items-center justify-center gap-2 rounded-full whitespace-nowrap select-none disabled:pointer-events-none disabled:opacity-50";

const variantClasses: Record<Variant, string> = {
  primary:
    "bg-button-primary-surface text-button-primary-text border-2 border-button-primary-surface hover:bg-button-primary-surface-hover hover:border-button-primary-surface-hover hover:text-button-primary-text-hover",
  secondary:
