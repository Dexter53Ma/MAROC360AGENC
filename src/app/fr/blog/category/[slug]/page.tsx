...
export async function generateMetadata({
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `${siteConfig.url}/fr/blog/category/${cat}`,
      languages: {
        en: `${siteConfig.url}/en/blog/category/${cat}`,
        fr: `${siteConfig.url}/fr/blog/category/${cat}`,
        "x-default": `${siteConfig.url}/en/blog/category/${cat}`,
      },
    },
  };
}
