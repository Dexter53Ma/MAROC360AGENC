...
export const metadata: Metadata = {
  ...
  alternates: pageAlternates({
    path: "/en/solutions/management-system",
    otherLocalePath: "/fr/services/management-system",
  }),
};
...
export default function ManagementSystemPage() {
  ...
  const url = absoluteUrl("/en/services/management-system");
  ...
  const crumbs = breadcrumbSchema([
    ...
    { name: "Services", item: absoluteUrl("/en/services") },
