...
export const metadata: Metadata = {
  alternates: pageAlternates({ path: "/en" }),
};
  ...
  return (
    <>
      ...
      <main id="main" tabIndex={-1}>
        <Hero dict={home.hero} />
        <LogoStrip dict={home.logoStrip} baseBlogHref="/en/blog" />
        ...
        <PillIllustration />
        <ExpertiseCarousel dict={home.expertise} contactHref="/en/contact" />
        <TestimonialsCarousel dict={home.testimonials} blogHref="/en/blog" />
