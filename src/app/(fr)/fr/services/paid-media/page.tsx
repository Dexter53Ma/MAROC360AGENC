...
export const metadata: Metadata = {
  ...
  alternates: pageAlternates({ path: "/fr/services/paid-media" }),
  openGraph: {
    title: `Publicité payante – ${siteConfig.name}`,
    description:
...
export default function PaidMediaPage() {
  ...
  const url = absoluteUrl("/fr/services/paid-media");
