...
const homeSeoAuditFormEN: HomePageDict["hero"]["seoAuditForm"] = {
  ...
  loadingHint:
    "Running 8 SEO categories. This usually takes 3–8 seconds…",
  ...
  footerPoweredBy: "Powered by Maroc 360's SEO audit",
  ...
  expandFixLabel: "How to fix",
  collapseFixLabel: "Hide steps",
  viewAllIssuesLabel: "View all issues",
  hideAllIssuesLabel: "Show fewer",
  issuesCountTemplate: "{n} issues found",
  copyCodeLabel: "Copy code",
  codeCopiedLabel: "Copied!",
  learnMoreLabel: "Learn more",
  ctaPitchPrefix: "Need a hand?",
...
const homeSeoAuditFormFR: HomePageDict["hero"]["seoAuditForm"] = {
  ...
  loadingHint:
    "Analyse de 8 catégories SEO. Comptez 3 à 8 secondes…",
  ...
  footerPoweredBy: "Propulsé par l'audit SEO de Maroc 360",
  ...
  expandFixLabel: "Comment corriger",
  collapseFixLabel: "Masquer les étapes",
  viewAllIssuesLabel: "Voir tous les problèmes",
  hideAllIssuesLabel: "Réduire la liste",
  issuesCountTemplate: "{n} problèmes détectés",
  copyCodeLabel: "Copier le code",
  codeCopiedLabel: "Copié !",
  learnMoreLabel: "En savoir plus",
  ctaPitchPrefix: "Besoin d'aide ?",
  ctaButtonLabel: "Parler à notre équipe",
  ctaHref: "/fr/contact",
};
